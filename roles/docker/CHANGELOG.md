...
## [Unreleased]
### Added
- Handle containers labels option

## [2.0.9] - 2021-06-16
### Added
- Handle containers etc_hosts option

## [2.0.8] - 2020-12-18
### Added
- `ignore` containers state
- Dict based daemon config

### Changed
- Flatten containers array
- Deprecate dict's array daemon config

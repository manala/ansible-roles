...
from ansible_collections.manala.roles.plugins.filter.php_config import config, config_parameter
...
class TestConfig(unittest.TestCase):
    ...
    def test_not_dict(self):
        ...
        self.assertEqual("php_config expects a dict but was given a <class 'NotImplementedType'>", str(error.exception))
...
class TestConfigParameter(unittest.TestCase):
    ...
    def test_not_dict(self):
        ...
        self.assertEqual("php_config_parameter parameters expects a dict but was given a <class 'NotImplementedType'>", str(error.exception))

    def test_not_string(self):
        with self.assertRaises(AnsibleFilterError) as error:
            config_parameter({}, NotImplemented)
        self.assertEqual("php_config_parameter key expects a string but was given a <class 'NotImplementedType'>", str(error.exception))

    def test_required(self):
        with self.assertRaises(AnsibleFilterError) as error:
            config_parameter({'foo': 'foo'}, 'bar', required=True)
        self.assertEqual('php_config_parameter requires a value for key bar', str(error.exception))
    ...
    def test_default(self):
        ...
        self.assertEqual('php_config_parameter missing a default value for key foo', str(error.exception))
    ...
    def test_unknown_type(self):
        ...
        self.assertEqual('php_config_parameter value of an unknown type <class \'NotImplementedType\'>', str(error.exception))
